...
// app.use(cors());
// const secret_admin_key = "12345";
// // Database Connection With MongoDB
// mongoose.connect("mongodb+srv://pngbmcc:Vinay%401234@ecommerce.iuzby.mongodb.net/Ecommerce?retryWrites=true&w=majority");
...
//     let existingAdmin = await adminSchema.findOne({ email: req.body.email });
//     if (existingAdmin) {
//       return res.status(400).json({ success, error: "Admin with this email already exists." });
//     }
